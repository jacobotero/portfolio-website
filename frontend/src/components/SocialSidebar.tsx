const LINKS = [
  ...
  },
  {
    ...
    icon: (
      <>
        <path d="M6.94 8.5H3.56V21h3.38V8.5ZM5.25 3a1.96 1.96 0 1 0 0 3.92 1.96 1.96 0 0 0 0-3.92ZM21 21h-3.38v-6.5c0-1.55-.03-3.55-2.17-3.55-2.17 0-2.5 1.7-2.5 3.44V21H9.57V8.5h3.24v1.7h.05c.45-.86 1.56-1.77 3.2-1.77 3.42 0 4.94 2.25 4.94 6.03V21Z" />
      </>
    ),
  },
  {
    ...
    icon: (
      <path d="M3 5h18a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1Zm1.7 2 7.3 5.5L19.3 7H4.7ZM4 8.2V17h16V8.2l-8 6-8-6Z" />
    ),
  },
]
    ...
    <div className="hidden lg:flex fixed left-6 top-1/2 -translate-y-1/2 z-30 flex-col items-center gap-4">
      {LINKS.map((link) => (
        <a
          ...
          title={link.label}
          className="w-9 h-9 flex items-center justify-center border border-border rounded-full text-text-dim hover:text-accent hover:border-accent-dim transition-colors bg-bg/60 backdrop-blur-sm"
        >
          <svg
